...
你可以选择使用[WebTooys中部署的在线版本](https://t.ftz.is-a.dev/builts/fakenet/index.html)，开启本地开发服务器

You can choose to use the [online version deployed in WebTooys](https://t.ftz.is-a.dev/builts/fakenet/index.html), or start the local development server
